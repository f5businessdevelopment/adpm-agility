...
expect eof
EOF
sudo chmod +x ./http && sudo ./http && sleep 10 &&  sudo unzip /usr/share/elasticsearch/elasticsearch-ssl-http.zip && sleep 10 && sudo cp /home/elkuser/kibana/elasticsearch-ca.pem /etc/kibana && cp /home/elkuser/kibana/elasticsearch-ca.pem /etc/logstash && sudo cp /home/elkuser/elasticsearch/http.p12 /etc/elasticsearch && sudo cp /usr/share/elasticsearch/elastic-stack-ca.p12 /etc/elasticsearch && sudo cp /usr/share/elasticsearch/elastic-certificates.p12 /etc/elasticsearch && sudo systemctl stop elasticsearch
